package com.example.pockie.presentation.ui.friends.requests
...
class RequestsPageAdapter(private val onClick: (User) -> Unit): ListAdapter<User, RecyclerView.ViewHolder>(RequestPageDiffCallback()) {
